...
Then run "pip install -r requirements.txt" to download the dependencies.
...
flask --app app run. Note that since we used individual databases that have the same data you need to change the connection calls to either db.py or connect.py and change the variables related to your database (i.e database name, password etc) to ensure that it connects to your database on your device.  
